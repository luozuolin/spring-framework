...
import org.springframework.luozlspringtest.springsource.spring04.Dog;

public class Spring04Test {
    //Spring实例化Bean的3种方式
    //参考文章：https://blog.csdn.net/li_canhui/article/details/89705191
    ...
    public void initXmlBeanFactory() {
        ...
        System.out.println("\n========测试方法开始=======\n");
        xmlBeanFactory = new XmlBeanFactory(new ClassPathResource("spring04/bean.xml"));
    }
